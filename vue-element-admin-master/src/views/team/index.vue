<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="社团名称" width="150px">
        <template slot-scope="{row}">
          <span>{{ row.name }}</span>
        </template>
      </el-table-column>
      <el-table-column label="社团类型" width="120px" align="center">
        <template slot-scope="{row}">
      ...
      <el-table-column label="建团时间" width="250px" align="center">
        <template slot-scope="{row}">
      ...
      <el-table-column label="状态" class-name="status-col" width="120">
        <template slot-scope="{row}">
          <el-tag :type="row.status | statusFilter">
            ...
            <span v-if="row.status==0" type="danger">禁用</span>
          </el-tag>
        </template>
      </el-table-column>
