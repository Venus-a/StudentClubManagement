<template>
  <div class="app-container">
    ...
    >
      <el-table-column label="ID" prop="系统编号" sortable="custom" align="center" width="100" :class-name="getSortClass('id')">
      ...
      <el-table-column label="真是姓名" width="150px" align="center">
        <template slot-scope="{row}">
...
export default {
  ...
  methods: {
    ...
    updateData() {
      /**
       * 1获取信息 注意id
       * 2吧获取到的内容 同各国修改接口传入到后端服务器
       * 3根据后端返回结果集
       * 如果成功 重新加载table 关闭form单
      * */
