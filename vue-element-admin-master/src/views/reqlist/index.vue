<template>
  <div class="app-container">
    ...
    >
      <el-table-column label="ID" prop="系统编号" sortable="custom" align="center" width="80px" :class-name="getSortClass('id')">
      ...
      <el-table-column label="状态" class-name="status-col" width="120">
        <template slot-scope="{row}">
          <el-tag :type="row.status | statusFilter">
            ...
            <span v-if="row.status==2" style="color: red">拒绝加如</span>
      ...
      <el-table-column label="操作" align="center" width="300" class-name="small-padding fixed-width">
        <template slot-scope="{row,$index}">
          ...
          <el-button v-if="row.status==0" size="mini" type="success" @click="handleUpdate(row)">
            审核
          </el-button>
    ...
    <el-dialog title="申请详细" :visible.sync="dialogFormVisible2">
      ...
      <el-form :inline="true" :model="temp" class="demo-form-inline">
        <el-form-item label="姓名">
          <el-input v-model="temp.realname" placeholder="" readonly />
        </el-form-item>
        <el-form-item label="性别">
          <el-input v-model="temp.sex" readonly />
        </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      // 状态码
      statusList: [{ id: 2, value: '不同意' }, { id: 1, value: '同意' }],
  ...
  methods: {
    ...
    createData() {
       ...
       * 2提交数据信息
       * 3获取后端接口返回的状态码
       * 4如果成功 重新加载table 让显示最新的数据 同时form窗口隐藏
       * */
